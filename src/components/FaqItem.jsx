  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        <p className="font-semibold md:text-2xl text-xl group-hover:text-cyan-600 transition-all duration-300 ease-in-out ">{pregunta}</p>
      ...
      >
        <p className="text-stone-300 md:text-xl text-md">{respuesta}</p>
      </div>
    </li>
  );
};
