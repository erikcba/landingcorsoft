...
const Form = () => {
    return (
        <>
            <form data-aos="fade-left" className='grid grid-cols-1 gap-4 w-3/4 backdrop-blur-lg bg-sky-900 bg-opacity-50 px-5 py-8 border-l-4 border-cyan-800 hover:border-cyan-600 transition-all ease-in-out duration-300  ' action="">
