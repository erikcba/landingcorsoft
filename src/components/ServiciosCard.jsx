...
const ServiciosCard = ({ titulo, descripcion, icono }) => {
    return (
        <div className='group backdrop-blur-md bg-gray-950 bg-opacity-50 rounded-md  transition-all ease-in-out shadow-lg select-none p-5 flex flex-col items-center justify-start gap-4'>
