...
const Contacto = () => {
    return (
        <section id='contacto' data-aos="fade-up" className='bg-slate-950 md:py-40 py-20 px-6 md:px-0'>
            <div className='container mx-auto flex items-center justify-center  md:gap-20 gap-12'>
                <div className='flex flex-col justify-start items-start gap-5 md:px-32'>
                    <h1 className='md:text-5xl text-gray-200 font-bold text-start ' >¿Listo para Impulsar tu Negocio?</h1>
                    <p className='md:text-2xl text-gray-300 text-start'>Agenda una consulta gratuita y analicemos juntos cómo podemos ayudarte a alcanzar tus objetivos.</p>
