...
const Servicios = () => {
    ...
    return (
        <section id='servicios' data-aos="fade-up" className='bg-slate-900 py-24'>
            <div className='container mx-auto flex flex-col gap-20 w-full '>
                <div className='flex flex-col items-center justify-center gap-20'>
                    <h1 className='text-gray-100 text-center text-3xl sm:text-5xl font-bold border-l-8 border-cyan-600 bg-slate-800 leading-none pb-4 px-4 pt-3 shadow-lg select-none hover:border-cyan-400 transition-all duration-300 ease-in-out'>Nuestros servicios</h1>
                </div>
                <div className='sm:grid flex flex-col items-center justify-center px-5 sm:grid-cols-4 gap-4'>
